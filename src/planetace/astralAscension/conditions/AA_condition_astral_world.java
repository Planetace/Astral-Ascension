package planetace.astralAscension.conditions;
...
public class AA_condition_astral_world extends BaseMarketConditionPlugin {
    public static float HAZARD_REDUCTION = -50f;
    public static float ACCESS_BONUS = 300f;
    public static float INCOME_MULTIPLIER = 3f;
    public static float FLEET_ADDITION = 400f;
    public static float FLEET_MULTIPLIER = 2.5f;
    public static float GROUND_ADDITION = 5f;


    public void apply(String id) {
        super.apply(id);
        // Modify Market Aspects
        market.getHazard().modifyFlat(id,HAZARD_REDUCTION/100f,"Astral World");
        market.getAccessibilityMod().modifyFlat(id,ACCESS_BONUS/100f, "Astral World");
        market.getIncomeMult().modifyMult(id,INCOME_MULTIPLIER, "Astral World");
        // Modify Military Aspects
        market.getStats().getDynamic().getMod(Stats.COMBAT_FLEET_SIZE_MULT).modifyFlat(id, FLEET_ADDITION/100f, "Astral World");
        market.getStats().getDynamic().getMod(Stats.COMBAT_FLEET_SIZE_MULT).modifyMult(id, FLEET_MULTIPLIER, "Astral World");
        market.getStats().getDynamic().getMod(Stats.GROUND_DEFENSES_MOD).modifyMult(id, GROUND_ADDITION,"Astral World");
    }
