...
package planetace.astralAscension.campaign.econ;
...
public class ColonyRebuilder implements EconomyAPI.EconomyUpdateListener {

    // Logger
    private static final Logger log = Global.getLogger(ColonyRebuilder.class);
