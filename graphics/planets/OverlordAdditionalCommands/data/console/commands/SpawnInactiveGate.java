...
public class SpawnInactiveGate implements BaseCommand
{
    @Override
    public CommandResult runCommand(String args, CommandContext context) {
		...
		final AddedEntity added = BaseThemeGenerator.addNonSalvageEntity(system, loc, Entities.INACTIVE_GATE, Factions.NEUTRAL);
		
		if (added != null) {
			BaseThemeGenerator.convertOrbitNoSpin(added.entity);
			
			Console.showMessage("Inactive gate spawned");
			return CommandResult.SUCCESS;
		}

        Console.showMessage("Something went wrong spawning inactive gate");
